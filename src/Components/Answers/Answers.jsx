  ...
  return (
    <div className="pt-20 px-4">
      ...
      <div className="pt-10 grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="bg-gray-color p-4 rounded-lg shadow-lg border border-gray-300">
          ...
          <p className="text-sm text-gray-700 mt-2">
            Yes, our platform comes in various sizes and configurations, making
            them suitable for practices of all sizes.
          </p>
        </div>
        <div className="bg-gray-color p-4 rounded-lg shadow-lg border border-gray-300">
          <div className="flex justify-between items-center">
            <p className="text-sm text-gray-700">
              Does the medical dashboard platform integrate with other
              healthcare software, such as Electronic Health Record (EHR)
              systems?
            </p>
      ...
      <div className="pt-10 grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="space-y-4">
          <div className="bg-gray-color p-3 rounded-lg shadow-lg border border-gray-300 min-h-[100px] flex justify-between items-center">
            <p className="text-sm text-gray-700">
              Can I customize a medical dashboard platform to fit my specific
              practice needs?
            </p>
            <div className="text-custom-green">
              <FaPlus />
