...
function Discover() {
  return (
    <div className="pt-3 mt-14">
      <div className="pt-8 flex flex-col md:flex-row items-center justify-between w-full max-w-6xl mx-auto">
        {/* Left Side - First Image */}
        <img
          src={image1}
          alt=""
          className="rounded-xl w-3/4 md:w-1/4 mb-4 md:mb-0 flex-shrink-0"
        />
        ...
        <div className="text-center flex-grow mx-4">
          ...
          <div className="font-bold text-2xl md:text-4xl">
            ...
            <div className="flex flex-col md:flex-row pt-3 space-y-2 md:space-y-0 md:space-x-2 items-center justify-center">
              <div className="text-lg border border-gray-500 px-2 py-1 rounded-lg">
                <input
                  type="text"
                  placeholder="Your Email Address"
                  className="w-full md:w-60 px-2 py-1 border-none outline-none"
                />
              </div>
        ...
        <img
          src={image2}
          alt=""
          className="rounded-xl w-3/4 md:w-1/4 mt-4 md:mt-0 flex-shrink-0"
        />
      </div>
    </div>
  );
